              ...
              isMobile ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 w-full min-w-0">
                    ...
                    <div className="text-right flex-1 min-w-0 overflow-hidden">
                      ...
                      <p className="text-xs text-blue-600 font-mono font-medium mt-1 line-clamp-1 break-all">
                        {teacher.username}
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="text-right min-w-0 overflow-hidden w-full max-w-full">
                    <div className="text-gray-500 truncate font-mono text-xs font-medium w-full max-w-full block">
                      {teacher.username}
                    </div>
                  </div>
