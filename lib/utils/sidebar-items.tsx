...
export const useTeacherSidebarItems = (
...
export const useStudentSidebarItems = (
  activeSection: string = "absences",
): SidebarItem[] => {
  const router = useRouter();
...
export const useDepartmentHeadSidebarItems = (
  activeSection: string = "entry",
): SidebarItem[] => {
  const router = useRouter();
  ...
  return useMemo(
    () => [
      ...
      },
      {
        ...
        href: "/department-head/specializations",
        onClick: () => router.push("/department-head/specializations"),
        isActive: activeSection === "specializations",
      },
      {
        label: "طلاب القسم",
        icon: (
